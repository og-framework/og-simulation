...
// [Task 61] SimulationTypes — PlainType alias and base isSimilarToField overloads.
// No project dependencies — only standard library headers.

#include <cmath>
#include <concepts>

// [Task 34] PlainType — strips const and references. Defined once here; all simulation
...
// ---------------------------------------------------------------------------
// [Task 35] isSimilarToField — per-field similarity helper
